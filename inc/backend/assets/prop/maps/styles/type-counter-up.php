...
return array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'name'        => '.cup_label_cont|text-align',
            'default'     => null,
            'custom_css'  => null,
            'custom_data' => array(
                array(
        ...
        array(
            'type'        => 'field-color',
            'label'       => esc_html__( 'Color', 'page-builder-wp' ),
            'name'        => '.cup_number, .includethis. .cup_number_suffix|color',
            'default'     => null,
            'custom_css'  => null,
            'custom_data' => array(
                array(
        ...
        array(
            'type'        => 'field-fonts-picker',
            'label'       => esc_html__( 'Font Family', 'page-builder-wp' ),
            'name'        => '.cup_number, .includethis. .cup_number_suffix|font-family',
            'default'     => null,
            'custom_css'  => null,
            'custom_data' => array(
                array(
        ...
        array(
            'type'        => 'field-number',
            'label'       => esc_html__( 'Font Size', 'page-builder-wp' ),
            'name'        => '.cup_number, .includethis. .cup_number_suffix|font-size',
            'default'     => null,
            'custom_css'  => null,
            'custom_data' => array(
                array(
        ...
        array(
            'type'        => 'field-font-weight',
            'label'       => esc_html__( 'Font Weight', 'page-builder-wp' ),
            'name'        => '.cup_number, .includethis. .cup_number_suffix|font-weight',
            'default'     => null,
            'custom_css'  => null,
            'custom_data' => array(
                array(
        ...
        array(
            ...
            'name'        => '.cup_number, .includethis. .cup_number_suffix|text-align',
            'default'     => null,
            'custom_css'  => null,
            'custom_data' => array(
                array(
        ...
        array(
            ...
            'name'        => '.cup_icon_cont i|background',
            'default'     => null,
            'custom_css'  => null,
            'custom_data' => array(
                array(
        ...
        array(
            ...
            'name'        => '.cup_icon_cont i|border-radius',
            'default'     => null,
            'custom_css'  => array(
                array(
        ...
        array(
            ...
            'name'        => '.cup_item_cont|color-gradient',
            'default'     => null,
            'custom_css'  => null,
            'custom_data' => array(
                array(
        ...
        array(
            'type'        => 'field-corners',
            'label'       => esc_html__( 'Border Radius', 'page-builder-wp' ),
            'name'        => '.cup_item_cont|border-radius',
            'default'     => null,
            'custom_css'  => array(
                array(
                    '.m-f-u-li-link .wpc-i-move',
